...
class InformeCadastroRepresentanteGovernoIpeaEmail extends Email
{
	public function enviar($destinatario, $assunto, $usuario)
	{
		$conteudo = $this->obterConteudo($usuario);
		return $this->enviarEmail($destinatario, $assunto, $conteudo);
	}
	
    public function obterConteudo($usuario)
    {
    	...
    	<p style="text-indent: 2.5em;text-align: justify;"> <font size="4" face="Roboto, arial narrow, helvetica condensed, helvetica, arial, sans-serif">Um representante de governo se cadastrou no Mapa das OSCs.</font> </p>
