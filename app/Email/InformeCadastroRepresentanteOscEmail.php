...
{
	public function enviar($destinatario, $assunto, $representanteOsc, $nomeOsc)
	{
		$conteudo = $this->obterConteudo($representanteOsc, $nomeOsc);
    ...
    public function obterConteudo($representanteOsc, $nomeOsc)
    {
    	...
    	<p style="text-indent: 2.5em;text-align: justify;"> <font size="4" face="Roboto, arial narrow, helvetica condensed, helvetica, arial, sans-serif">Um representante da  <b> ' . $nomeOsc . '</b> se cadastrou no Mapa das OSCs. Ele está habilitado a inserir dados na página individual da organização.</font> </p>
