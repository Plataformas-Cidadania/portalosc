    		...
    		if(!$bo_oficial){
    			...
    			foreach($json_outro as $key_outro => $value_outro){
    				if($id_conselho == $value_outro->id_conselho){
	    				...
	    				else $ft_nome_conselho = $value_outro->ft_nome_conselho;
    				}
    			}
