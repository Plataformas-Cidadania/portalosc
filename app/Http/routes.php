...
foreach($listaPrefix as $prefix){
	...
	$app->group(['prefix' => $prefix . '/osc', 'middleware' => ['cors']], function () use ($app) {
		...
		$app->get('projeto_abreviado/{id}', 'App\Http\Controllers\ProjetoController@obterProjetos');
	...
	$app->group(['prefix' => $prefix . '/analises', 'middleware' => ['cors']], function () use ($app) {
		...
		$app->get('idhgeo/{id}', 'App\Http\Controllers\AnalisesController@obterDadosGeograficosIDH');
        $app->get('idhgeo/', 'App\Http\Controllers\AnalisesController@obterDadosGeograficosIDHuf');
	});
