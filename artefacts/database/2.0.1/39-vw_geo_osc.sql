...
DROP MATERIALIZED VIEW IF EXISTS osc.vw_geo_osc CASCADE;
CREATE MATERIALIZED VIEW osc.vw_geo_osc
AS
...
-- ddl-end --
ALTER MATERIALIZED VIEW osc.vw_geo_osc OWNER TO postgres;
-- ddl-end --