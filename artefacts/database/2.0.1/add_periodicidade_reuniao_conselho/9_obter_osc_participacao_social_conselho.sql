...
CREATE OR REPLACE FUNCTION portal.obter_osc_participacao_social_conselho(param TEXT) RETURNS TABLE (
	...
	tx_nome_periodicidade_reuniao_conselho TEXT, 
...
BEGIN 
	RETURN QUERY 
		SELECT 
			...
			vw_osc_participacao_social_conselho.cd_periodicidade_reuniao_conselho, 
			vw_osc_participacao_social_conselho.tx_nome_periodicidade_reuniao_conselho, 
