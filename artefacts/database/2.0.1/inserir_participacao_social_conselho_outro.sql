...
cdperiodicidadereuniaoconselho integer, ftperiodicidadereuniao text, 
...
BEGIN
	INSERT INTO osc.tb_participacao_social_conselho (id_conselho, id_osc, cd_conselho, ft_conselho, cd_tipo_participacao, ft_tipo_participacao, cd_periodicidade_reuniao_conselho, ft_periodicidade_reuniao, dt_data_inicio_conselho, ft_data_inicio_conselho, dt_data_fim_conselho, ft_data_fim_conselho, bo_oficial) 
	VALUES (DEFAULT, id, cdconselho, ftconselho, cdtipoparticipacao, fttipoparticipacao, cdperiodicidadereuniaoconselho, ftperiodicidadereuniao, datainicioconselho, ftdatainicioconselho, datafimconselho, ftdatafimconselho, oficial)
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION portal.inserir_participacao_social_conselho_outro(integer, integer, text, text, text, integer, text, integer, text, date, text, date, text, boolean)
  OWNER TO postgres;
