...
SELECT
	...
	(SELECT tx_nome_tipo_participacao FROM syst.dc_tipo_participacao WHERE cd_tipo_participacao = tb_participacao_social_conselho.cd_tipo_participacao)::TEXT AS tx_nome_tipo_participacao,
