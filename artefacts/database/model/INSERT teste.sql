...
INSERT INTO osc.tb_osc (cd_identificador_osc, ft_identificador_osc, bo_osc_ativa,  ft_osc_ativa)
VALUES (11111111111111, 'OSCIP', true, 'OSCIP');

INSERT INTO osc.tb_osc (cd_identificador_osc, ft_identificador_osc, bo_osc_ativa,  ft_osc_ativa)
VALUES (11111111111112, 'RAIS', true, 'RAIS');
...
SELECT * FROM portal.update_representation(
	(SELECT id_usuario FROM portal.tb_usuario WHERE tx_email_usuario = 'vagnerpraia@gmail.com'),
	array[(SELECT id_osc FROM osc.tb_osc WHERE cd_identificador_osc = 12345678901234)]
);