...
CREATE OR REPLACE FUNCTION portal.inserir_area_atuacao_projeto(id INTEGER, idprojeto INTEGER, nomeareaatuacaodeclarada TEXT, ftnomeareaatuacaodeclarada TEXT, ftareadeclarada TEXT, ftareaatuacaooutra TEXT)
 RETURNS BOOLEAN AS $$
...
BEGIN
	...
	INSERT INTO osc.tb_area_atuacao_outra (id_area_atuacao_outra, id_osc, id_area_declarada, ft_area_declarada) 
	VALUES (DEFAULT, id, id_atuacao_declarada, ftareadeclarada)
	RETURNING id_area_atuacao_outra INTO id_atuacao_outra;

	INSERT INTO osc.tb_area_atuacao_outra_projeto (id_projeto, id_area_atuacao_outra, ft_area_atuacao_outra) 
