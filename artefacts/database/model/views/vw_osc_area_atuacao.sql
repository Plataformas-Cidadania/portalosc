...
SELECT
	...
	tb_dados_gerais.cd_subclasse_atividade_economica_osc AS cd_atividade_economica,
	(SELECT tx_nome_subclasse_atividade_economica FROM syst.dc_subclasse_atividade_economica WHERE cd_subclasse_atividade_economica = tb_dados_gerais.cd_subclasse_atividade_economica_osc) AS tx_nome_atividade_economica,
