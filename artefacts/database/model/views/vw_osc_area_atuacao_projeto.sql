...
FROM osc.tb_osc
INNER JOIN osc.tb_area_atuacao_projeto
ON tb_area_atuacao_projeto.id_projeto IN (SELECT id_projeto FROM osc.tb_projeto WHERE tb_projeto.id_osc = tb_osc.id_osc)
