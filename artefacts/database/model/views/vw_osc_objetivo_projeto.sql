...
SELECT
	...
	(SELECT tx_codigo_objetivo_projeto || '. ' || tx_nome_objetivo_projeto FROM syst.dc_objetivo_projeto WHERE cd_objetivo_projeto = (SELECT cd_objetivo_projeto FROM syst.dc_meta_projeto WHERE cd_meta_projeto = tb_objetivo_projeto.cd_meta_projeto)) AS tx_nome_objetivo_projeto,
	tb_objetivo_projeto.cd_meta_projeto,
	(SELECT tx_codigo_meta_projeto || ' ' || tx_nome_meta_projeto FROM syst.dc_meta_projeto WHERE cd_meta_projeto = tb_objetivo_projeto.cd_meta_projeto) AS tx_nome_meta_projeto,
